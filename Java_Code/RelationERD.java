...
public class RelationERD {
    ...
    /**
     * Constructeur pour créer une relation ERD
     * @param entiteSource Entité source de la relation
     * @param entiteCible Entité cible de la relation
     * @param entiteToGroup Map des entités vers leurs groupes visuels
     * @param relationNom Nom de la relation à afficher dans l'ellipse
     * @param cardSource Cardinalité côté source
     * @param cardCible Cardinalité côté cible
     */
    ...
    /**
     * Calcule le point de connexion sur le bord d'une entité vers un point cible
     */
    ...
    public Line getLigne1() { return ligne1; }
    public Line getLigne2() { return ligne2; }
    public Group getRelationGroup() { return relationGroup; }
    public Text getCardinaliteSourceText() { return cardinaliteSourceText; }
    public Text getCardinaliteCibleText() { return cardinaliteCibleText; }
    
    // Getters pour les entités
    public Map<String, Object> getEntiteSource() { return entiteSource; }
    public Map<String, Object> getEntiteCible() { return entiteCible; }
